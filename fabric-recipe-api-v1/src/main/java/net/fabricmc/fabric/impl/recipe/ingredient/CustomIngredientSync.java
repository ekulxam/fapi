...
public class CustomIngredientSync implements ModInitializer {
	...
	public void onInitialize() {
		...
		ServerConfigurationNetworking.registerGlobalReceiver(ServerboundCustomIngredientPayload.TYPE, (payload, context) -> {
			...
			((SupportedIngredientsConnection) ((ServerCommonPacketListenerImplAccessor) context.packetListener()).fabric_getConnection()).fabric_setSupportedCustomIngredients(supportedCustomIngredients);
